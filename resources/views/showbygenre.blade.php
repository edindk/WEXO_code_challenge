...
<div class="container">
    <div class="row mb-2 mt-2">
        ...
        <div class="col col-lg-2 offset-lg-4 justify-content-end">
            <a href="http://127.0.0.1:8000/showall/{{$genre}}"><button type="button" class="btn btn-success w-100">Vis alle</button></a>
        </div>
    </div>
